...
const ConfirmDialog: React.FC<ConfirmDialogProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[999] flex items-center justify-center bg-black/60 dark:bg-black/80 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="w-full max-w-sm rounded-2xl bg-white dark:bg-[#131b2e] border border-slate-200 dark:border-white/10 shadow-2xl p-6 transform scale-100 transition-all">
        ...
        <div className="flex justify-end gap-3">
          ...
          <button onClick={onConfirm} className="px-4 py-2 rounded-xl text-xs font-bold bg-rose-600 text-white shadow-lg shadow-rose-900/20 dark:shadow-rose-900/50 hover:bg-rose-500 transition-all active:scale-95">
            {confirmLabel}
          </button>
        </div>
      </div>
